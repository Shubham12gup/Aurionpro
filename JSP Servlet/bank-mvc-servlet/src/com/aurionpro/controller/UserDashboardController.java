...
public class UserDashboardController extends HttpServlet {
	...
	private void searchByDate(HttpServletRequest request, HttpServletResponse response)
		...
		List<Transaction> transactions = userDBUtil.searchByDate(id, fromDate, toDate);
	...
	private void displayTransactionForm(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
	...
	private void displayPassbook(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
