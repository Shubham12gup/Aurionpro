...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container-fluid">
	...
	<form action="AdminDashboardController">
		<button type="submit" class="btn btn-lg btn-dark">Add User</button>
	...
	<form action="AdminDashboardController">
		<div class="row g-3">
		<div class="col-sm-8">
			<input type="text" class="form-control w-100" placeholder="Search here" name="q">
		</div>
		<div class ="col-sm">
		...
		<c:if test="${userList == null}">
			...
			<c:forEach var="users" items="${userList}">
				...
				<tr>
					...
					<td>${users.balance}</td>
					<td><a href="${updateLink}"> <input type="button" class="btn btn-outline-dark" value="Update"></a></td>
					<td><a href="${deleteLink}"> <input type="button" class="btn btn-dark" value="Delete"></a></td> 
				</tr>
