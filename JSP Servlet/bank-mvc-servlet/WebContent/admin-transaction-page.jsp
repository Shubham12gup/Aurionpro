...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
 ...
 <a class="navbar-brand" href="AdminDashboardController?command=displayDashboard">Admin Dashboard</a>
	...
	<form action="AdminDashboardController">
		...
		<div class="d-flex">
			<div class="p-2">
				<label for="searchByID"><b>Search by UserID</b></label><br> 	
				<input type="text" class="form-control-sm border-dark" id="searchByID" placeholder="Enter UserID" name="q">
			</div>
			<div class="p-2">
				<label for="fromDate"><b>From Date </b></label><br>
				<input type="date" id="fromDate" name="fromDate" class="form-control-sm">
			</div>
			<div class="p-2">
				<label for="toDate" class=""><b>To Date</b></label><br>
				<input type="date" id="toDate" name="toDate" class="form-control-sm">
			</div>
		</div>
		<br>
