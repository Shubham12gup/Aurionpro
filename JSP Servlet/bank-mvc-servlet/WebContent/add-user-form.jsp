	...
	<div class="container-sm">
		...
		<form action="AdminDashboardController" method="POST" id="#Form">
			...
			<label for="username"> User Name: </label> <input type="text"
				class="form-control" name="username" placeholder="Enter User Name" required="required">



			<label for="password"> User Password: </label> <input type="text"
				class="form-control" name="password" placeholder="Enter Password" required="required">


			<label for="balance"> User Balance: </label> <input type="number"
				class="form-control" name="balance"  value = "1000" placeholder="Add Balance" required="required">
