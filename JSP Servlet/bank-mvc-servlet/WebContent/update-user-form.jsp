   ...
   <form action="AdminDashboardController" > 
          ...
          <div>
            ...
            <div>
                ...
                <br>
                <input type="text" name="username" class="form-control" value="${updateUser.userName}" required="required">
            </div>
            <div>
                <label for="password">  Update Password: </label>
                <br>
                <input type="text" name="password" class="form-control" value="${updateUser.userPass}" required="required">
            </div>
            <div>
