async function loadIntoTable(url,table){
    ...
    data.forEach(element => {
        ...
        `<tr>
            ...
            <td>${element.age}</td>
            <td>${element.email}</td>
            <td><button class= "delete" id="${element.id}" onclick="deleteStudent(this)">Delete</button></td>
            <td><button class= "update" id="${element.id}" onclick="update(this)">Edit</button></td>
