...
public class GuitarTest {
	public static void main(String[] args) {
		...
		GuitarSpec whatReenaLikes = new GuitarSpec(Builder.GIBSON, "Les Paul", Type.ELECTRIC, 6, Wood.MAHOGANY,
				Wood.MAHOGANY);
		List matchingGuitars = inventory.search(whatReenaLikes);
		if (!matchingGuitars.isEmpty()) {
			System.out.println("Reena, you might like these guitars:");
